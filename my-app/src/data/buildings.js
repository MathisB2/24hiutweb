export const buildings = [

    {
        ...
        desc: "Métamorphosée par la couleur et une esthétique abstraite, la façade de la cathédrale nous surprend, une fois encore. Puissance, variété des ornements, magnétisme et beauté sont révélés dans cette 	œuvre. Mother joue sur les contrastes, les ruptures de rythme, les équilibres et les forces en jeu. La façade de pierre devient montagne et rochers. Elle est le théâtre d’éclairs flamboyants ou de mouvements 	lents, elle reçoit le vent et l’eau. Elle semble être un paysage dont les éléments bougent et vibrent. La musique qui mêle sons réels et fictifs nous immerge… pour un spectacle total.",
        photo: '/src/data/001.jpg',
    },
    {
        id: "002",
        name: "Gare SNCF",
        desc: "Trois artistes proposent, chacun à leur tour, leur langage visuel, leur sensibilité, leur savoir technique et… leur imaginaire. Tous ont envie de partager avec nous ces projections aussi courtes que 	denses. Elles s’enchaînent sous nos yeux et nous interpellent. Elles sont décalées, audacieuses, mouvementées ou délicates… De la même façon qu'il faut être rapides et concentrés pour attraper un train 	certains jours, il faut être curieux et vifs pour capter ces trois créations dans les moindres détails ! Zouhour Saoud : Sur’impressions Expérience immersive : un travelling avant joue avec nos perceptions et 	notre regard qui se perd dans les transformations et les déformations visuelles. Les frontières entre le réel et le virtuel s’estompent… Dans cette projection, la créatrice évoque le voyage émotionnel : peu 	importe la destination ! La création sonore est signée Géraldine Kwik. Jésus Baptista : Amalia Voici une œuvre qui veut être un lien. ",
        photo: '/src/data/002.jpg',
    },
    {
        id: "003",
    ...
    photo: '/src/data/007.jpg',
    },
    {
        id: "008",
        name: "Place Antonin Poncet",
